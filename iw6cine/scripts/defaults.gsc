...
load_defaults()
{
    ...
    level.HIGHLIGHT_COLOR           = "^1";     // "^#" - q3 color code for the mod name in the print messages.
    ...
    level.BOT_FREEZE                = true;     // [true/false] - Freezes bots
    level.BOT_WEAPHOLD              = false;    // [true/false] - Makes bots hold their weapons on death by default
